...
All information about the date and time functions that are offered by default can be found in the xref::entity-query/eql-date.adoc[EQL date and time functions section.]
