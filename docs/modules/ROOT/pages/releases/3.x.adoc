...
* bugfix related to the entity of a parent `ViewElementBuilderContext` seeping down
* improments made to the `CollectionEntityQueryExecutor`
** now supports `Supplier`s
* improved exception handling
** uncaught exceptions are now registered as global validation errors and are shown on the regular crud views
