...
Most, if not all of the logic executed during a request is done by using view processors.
...
Initializes the `EntityViewCommand` for the current request.
