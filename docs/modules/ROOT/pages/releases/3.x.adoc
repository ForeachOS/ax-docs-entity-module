...
* support has been added for xref:property-controls/autosuggest.adoc[configuring Autosuggest controls] for single value properties that reference an entity
